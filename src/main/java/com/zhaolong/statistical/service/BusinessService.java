        ...
        for(int r=3;r<totalRows;r++){
            ...
            if(n>=0){
                ...
                if(strings.length==4){
                    ...
                    businessInfo.setChannel(strings[0]);
           ...
           if(keywordsRecordList.size()>0){
               for (KeywordsRecord keywordsRecord:keywordsRecordList) {
                   ...
                   if(keywordsRecord.getRecordDate().getYear()==businessInfo.getDate().getYear()){
                       if(keywordsRecord.getRecordDate().getMonth()==businessInfo.getDate().getMonth()){
                           if(keywordsRecord.getRecordDate().getDay()==businessInfo.getDate().getDay()){
